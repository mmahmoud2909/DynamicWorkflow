...
namespace DynamicWorkflow.Infrastructure.DataSeeding
{
    public static class ApplicationdbcontextSeed
    {
        ...
        //        var step1 = new WorkflowStep { Name = "Submit Request", WorkflowId = wf.Id, AssignedRole = Core.Enums.Roles.Employee };
        //        var step2 = new WorkflowStep { Name = "Manager Approval", WorkflowId = wf.Id, AssignedRole = Core.Enums.Roles.Manager };
        //        var step3 = new WorkflowStep { Name = "HR Confirmation", WorkflowId = wf.Id, AssignedRole = Core.Enums.Roles.HR, isEndStep = true };
